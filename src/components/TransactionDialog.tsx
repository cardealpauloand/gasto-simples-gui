...
const mockTags = [
  'Saúde', 'Comida', 'Trabalho', 'Familia', 'Investimento'
];
      ...
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value={typeInfo.tabValue} className="w-full">
          <TabsList className="grid grid-cols-3 w-full">
            <TabsTrigger value="Entrada" className="text-sm">Entrada</TabsTrigger>
            <TabsTrigger value="Transferência" className="text-sm">Transferência</TabsTrigger>
            <TabsTrigger value="Saída" className="text-sm">Saída</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value={typeInfo.tabValue} className="mt-6">
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex items-center border border-input rounded-md">
                      <Input
                        ...
                        required
                      />
                      <span className="px-3 py-2 text-sm text-muted-foreground border-l">BRL</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-2xl font-bold">
                      {formData.value ? `R$ ${parseFloat(formData.value).toFixed(2)}` : 'R$ 0,00'}
                    </span>
              ...
              <div className="flex justify-end">
                <Button
                  type="submit"
                  variant={type === 'income' ? 'income' : type === 'expense' ? 'expense' : 'transfer'}
                  className="w-full"
                >
                  Salvar
                </Button>
